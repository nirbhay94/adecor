                ...
                <div class="container-fluid">
                    ...
                    <div class="collapse navbar-collapse offset" id="navbarSupportedContent">
                       <ul class="nav navbar-nav menu_nav justify-content-center">
                                ...
                                <li class="nav-item active"><a class="nav-link" href="about-us.blade.php">About</a></li>
                                <li class="nav-item"><a class="nav-link" href="project.blade.php">Works</a>
                                    <li class="nav-item"><a class="nav-link" href="service.blade.php">Services</a></li>
        ...
        <div class="container">
          ...
          >
            ...
            <div class="page_link">
              ...
              <a href="contact.blade.php">Single Blog</a>
            </div>
          </div>
        </div>
      </div>
